...
class Agreement():
    ...
    @staticmethod
    def get_boundary_list(boundaries_conf):
        boundaries = boundaries_conf.keys()
        return boundaries

    @staticmethod
    def get_intersection_list(network_config):
        return sorted(network_config.areas["intersections"])

    @staticmethod
    def get_network_node_list(network_config):
        areas_configs = copy.copy(network_config.areas)
        boundary_list = Agreement.get_network_boundary_list(network_config)
    ...
    @staticmethod
    def get_network_road_list(network_config):
        intersection_list = copy.copy(network_config.areas["intersections"])
        links = []
