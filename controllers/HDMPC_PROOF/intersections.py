...
class Intersection():
    ...
    def phase_completed_signal(self, data):
        ...
        for road in incoming_roads:
            ...
            # if road== 'R35':
            #     input(departed)
            self.model_incoming_roads[ind].pre_update(actual_state, arrived, departed, num_vehicles, free_flow, duration)
        ...
        for road in outcome_roads:
            ...
            self.model_outcome_roads[ind].pre_update(0, arrived, 0, num_vehicles, free_flow, duration)
